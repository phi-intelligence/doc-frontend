...
import { FileText, ArrowLeft, Loader2, Copy, Check, Hash, MessageSquare, Image, Save, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            <FileText className={`w-8 h-8 ${isDark ? 'text-brand-accent-400' : 'text-brand-accent-500'}`} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className={`rounded-xl border p-6 ${
              ...
              <h3 className={`text-lg font-semibold mb-4 flex items-center gap-2 ${
                ...
                <MessageSquare className={`w-5 h-5 ${isDark ? 'text-brand-accent-400' : 'text-brand-accent-500'}`} />
                Content Details
              </h3>
          ...
          <div className={`rounded-xl border p-6 ${
            ...
            {processCard && (processCard.status === 'processing' || (processCard.status === 'completed' && !generatedContent && !generatedImage) || processCard.status === 'error') ? (
              ...
              <div className={`min-h-[300px] rounded-xl border-2 border-dashed flex items-center justify-center ${
                isDark 
                  ? 'bg-dark-sidebar border-dark-border' 
                  : 'bg-light-bg border-light-border'
              }`}>
