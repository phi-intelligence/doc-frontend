        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          >
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-brand-accent-100 rounded-xl flex items-center justify-center mx-auto mb-3">
                <FileText className="w-6 h-6 text-brand-accent-600" />
              </div>
              <h3 className="font-semibold text-light-text mb-1">Document Tools</h3>
              <p className="text-sm text-light-text-secondary">Word, Excel, PDF, PowerPoint</p>
            </div>
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-brand-accent-100 rounded-xl flex items-center justify-center mx-auto mb-3">
                <Image className="w-6 h-6 text-brand-accent-600" />
              </div>
              <h3 className="font-semibold text-light-text mb-1">Creative AI</h3>
              <p className="text-sm text-light-text-secondary">Images, Logos, Marketing</p>
            </div>
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-brand-accent-100 rounded-xl flex items-center justify-center mx-auto mb-3">
                <Sparkles className="w-6 h-6 text-brand-accent-600" />
              </div>
              <h3 className="font-semibold text-light-text mb-1">Smart Workflows</h3>
              <p className="text-sm text-light-text-secondary">Automate & Connect</p>
            </div>
          </motion.div>
        </div>
      </section>
